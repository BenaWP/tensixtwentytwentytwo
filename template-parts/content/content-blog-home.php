    ...
    <div class="post mb-5">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <div class="meta mb-1"><span class="date"> <?php the_date(); ?> </span><span class="comment"><a
                                href="#"> <?php comments_number(); ?> </a></span></div>
                <div class="intro"> <?php the_excerpt(); ?> </div>
                <a class="more-link"
                   href="<?php the_permalink(); ?>"><?php esc_html_e( 'Lire la suite &rarr;', 'tensixtwentytwentytwo' ); ?></a>
            </div>
            <!--//media-body-->
        </div>
        <!--//media-->
